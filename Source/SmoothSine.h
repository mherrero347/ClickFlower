...
#ifndef FAUSTCLASS 
#define FAUSTCLASS SmoothSine
#endif

class SmoothSine : public dsp {
  private:
	FAUSTFLOAT 	fentry0;
	int 	iVec0[2];
	float 	fConst0;
  ...
  public:
	...
	virtual SmoothSine* clone() {
		return new SmoothSine();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addNumEntry("gain", &fentry0, 1.0f, 0.0f, 0.0f, 1.0f);
